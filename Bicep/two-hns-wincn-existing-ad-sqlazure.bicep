import { AzureSqlDataBaseServiceTier, AzureSqlDatabaseSettings, HeadNodeImage, headNodeImages, WindowsComputeNodeImage, windowsComputeNodeImages, DiskType, diskTypes, DiskCount, DiskSizeInGB, YesOrNo, YesOrNoOrAuto, sharedResxBaseUrl } from 'shared/types-and-vars.bicep'
